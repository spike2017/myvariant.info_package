...
query_count = 1
while (query_count < 1000000):
    print(" count number now " + str(query_count))
    demo = query('23andme_large.txt','time_record.txt','23andme','csv', 19,'None',29,query_count)
    demo.genequery()
    query_count = query_count + 25000
